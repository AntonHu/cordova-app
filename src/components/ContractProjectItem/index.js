...
class ContractProjectItem extends React.PureComponent {
  static propTypes = {
    ...
    powerStationCapacity: PropTypes.string,
    ...
    return (
      <div className="contract-project-item">
        <div className="progress-box">
          <Progress percent={soldShare / (soldShare + availableShare) * 100} position="normal" />
        ...
        <div className="info-box">
          <div className="annul-box">
            ...
            <div className="number">{ annualRate }%</div>
          </div>
          <div className="name-box">
            <div className="project-name">{ projectName }</div>
            <div className="capacity">{ `电站容量：${powerStationCapacity}kW` }</div>
          </div>
        </div>

        <div className="bottom-box">
          <div className="enterprise-name">{ `发布企业：${enterpriseName}` }</div>
