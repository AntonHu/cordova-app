...
class SunIntegral extends React.Component {
  ...
  renderRow = (rowData, sectionID, rowID) => {
    // 添加默认icon和integralType
    let icon = '\ue611';
    let integralType = '挖宝积分';
    if (INTEGRAL_TYPE[rowData.addWay]) {
      icon = INTEGRAL_TYPE[rowData.addWay].icon;
      integralType = INTEGRAL_TYPE[rowData.addWay].title;
